...
# def linkedInMetaSearch(URL: str, jobs: dict, scrapedJobs: list) -> Tuple[Dict[str, List[int, str, str, str, str, str, str]], List[str]]:
# def linkedInMetaSearch(URL: str, jobs: dict, scrapedJobs: list) -> Tuple[Dict[str, List[int, str]], List[str]]:   
def linkedInMetaSearch(URL: str, jobs: dict, scrapedJobs: list) -> Tuple[Dict[int, str], List[str]]:
